...
class AuthCookieSecureFalseTest {
  @Autowired MockMvc mockMvc;
  @Autowired ObjectMapper om;

  @Test
  void signupSetCookieWithoutSecureAttributeWhenDisabled() throws Exception {
    SignupRequestDTO sr =
        SignupRequestDTO.builder()
            .email(
                "nosecure+"
                    ...
                    + "@example.com")
            .username("nosecure" + java.util.UUID.randomUUID().toString().substring(0, 6))
            .displayName("NoSecure")
    ...
    assertThat(joined).doesNotContain("Secure");
  }
}
