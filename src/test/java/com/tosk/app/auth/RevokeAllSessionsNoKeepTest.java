...
class RevokeAllSessionsNoKeepTest {
  @Autowired MockMvc mockMvc;
  @Autowired ObjectMapper om;

  @Test
  void revokeAllWithoutKeepCurrent() throws Exception {
    SignupRequestDTO sr =
    ...
    // revoke all without keepCurrent flag
    mockMvc
        .perform(delete("/api/auth/sessions").cookie(signup.getResponse().getCookies()))
